	...
	private void generateSpecialParticles() {
		...
		for (int frameIndex = 0; frameIndex < frames.size(); frameIndex++) {
			...
			for (int p = 0; p < numOfParticles; p++) {
				...
				particleCopy.xD = newParticle.xD;
				// particleCopy.xD = newParticle.xD.subtract(new
				// BigDecimal(1.50));
				// particleCopy.xD = particleCopy.xD.add(new BigDecimal(this
				// .getCTR()));
				particleCopy.yD = newParticle.yD;
				// particleCopy.yD = newParticle.yD.subtract(new
				// BigDecimal(1.50));
				// particleCopy.yD = particleCopy.yD.add(new BigDecimal(this
				// .getCTR()));
